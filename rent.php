...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO rental (pid, quantity, `from`, `to`, cid, total)
            VALUES ('$key', '$quantity', '$startDate', '$endDate', '$cid', '$total')";
...
if (!empty($products)) {
  ...
  echo '<div class="hero-section">';
    ...
    echo '<div class="hero-right">';
        ...
        echo '</div>';
        echo '<div class="cart">';
        echo '<form method="post" action="rent.php?key='.$key.'">';
            // echo '<a href="cart.php?type='.$_SESSION['type'].'&&key='.$key.'"';
            echo '<label HTMLto="from">Start Date</label>';
            echo '&nbsp;&nbsp;&nbsp;';
            echo '<input type="date" id="from" name="from">';
            echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
            echo '<label HTMLto="to">End Date</label>';
            echo '&nbsp;&nbsp;&nbsp;';
            echo '<input type="date" id="to" name="to">';
            echo '<br><br>';
            ...
            echo '<input id="button" type="submit" name="submit" value="Rent Now">';
    echo '</form>';
    echo '</div>';
